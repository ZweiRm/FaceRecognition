...
feature, reshape = pca(feature, dim=24)
print(feature.shape)
...
# 记录器
class_names = np.arange(0, 38, 1)
class_names = np.array(class_names)
logdir = './tensorboard_YaleB_Softmax_Regression_PCA'
...
def image_grid():
    ...
    for i in range(1, 26):
        ...
        images = np.reshape(reshape[i], (32, 32))
        images = images.T
...
def softmax_regression():
    ...
    model.add(layers.Dense(units=38, activation=tf.nn.softmax))
