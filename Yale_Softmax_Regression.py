...
# 划分 70%(115)训练； 30%(50)测试
train_data = feature[0:115]
train_label = label[0:115]

test_data = feature[115:]
test_label = label[115:]
...
logdir = './tensorboard_Yale_Softmax_Regression'
